...
<div class="container" style="border:2px solid black;background-color:#ebeeef;margin-top:80px;">
...
<div class="col-xs-6 previous">
<div></div>
<!--  <button type="submit" class="btn btn-secondary" type="hidden" style="margin-left:440px;margin-top:40px;">AddBooks</button>    </div>
 --> </div>
<button>
...
function checkValidtion()
{
	...
	if(id!=0)
		...
		var bookId = $('#jqGrid-table').jqGrid('getCell', id, 'Book_id');
		//alert(bookId);
...
function showFullDetails(id)
{
	...
	colModel : [
		...
		{ name : 'Book_id', index : 'Book_id', width : '400px', align : 'center',hidden:true},//Book_id
		...
		{ name : 'Created_Date', index : 'Created_Date', width : '300px', align : 'center'},
		 {name : 'Lend', index : 'lend',formatter: function(cellvalue, options, rowobject){
			 
		        return'<a style="font-weight: bold;color:red;cursor:pointer" onclick=lendBook('+options.rowId+')>Take</a>';
		    }},
